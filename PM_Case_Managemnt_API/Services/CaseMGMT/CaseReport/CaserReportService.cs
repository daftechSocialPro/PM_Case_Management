...
namespace PM_Case_Managemnt_API.Services.CaseMGMT
{
    public class CaserReportService : ICaseReportService
    {
        ...
        public async Task<List<EmployeePerformance>> GetCaseEmployeePerformace(string key)
        {
            ...
            _dbContext.Employees.Include(x => x.OrganizationalStructure).ToList().ForEach(employee =>
            {
