...
;(function(factory) {
    ...
    EvoCalendar = (function() {
        ...
        function EvoCalendar(element, settings) {
            ...
            let today = new Date()
            let{Month:amMonth,Year: amYear , Day: amDay}= getAmharicDate(today.getDate(),today.getMonth()+1,today.getFullYear()) 
          
            _.$current = {
                month: (isNaN(this.month) || this.month == null) ?   amMonth-1 :  this.month,
                year: (isNaN(this.year) || this.year == null) ? amYear: this.year,
                date: _.formatDate(_.initials.dates[_.defaults.language].months[amMonth-1]+' '+amDay+' '+ amYear, _.options.format)
            }
    ...
    function getAmharicDate ( intGCDay,  intGCMonth, intGCYear){
        
        let intDayDiff, intPagumen;
        let intECDay = 0;
        let intECMonth = 0;
        let intECYear = 0;
